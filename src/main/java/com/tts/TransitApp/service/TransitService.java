...
public class TransitService {
    ...
    private Location getCoordinates(String description){
        ...
        String url = geocodingUrl+description+"+GA&key="+google_api_key;
        RestTemplate restTemplate = new RestTemplate();
    ...
    private double getDistance(Location origin, Location destination){
        String url = distanceUrl+"origins="+origin.lat+","+origin.lng+
                "&destinations="+destination.lat+","+destination.lng+"&key="+google_api_key;
        RestTemplate restTemplate = new RestTemplate();
    ...
    public List<Bus> getNearbyBuses(BusRequest request){
        ...
        for(Bus bus : allBuses){
            ...
            double latDistance = Double.parseDouble(busLocation.lat) - Double.parseDouble(busLocation.lat);
            double lngDistance = Double.parseDouble(busLocation.lng) - Double.parseDouble(busLocation.lng);
